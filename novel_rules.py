...
{"question":"你的提问/确认内容","options":["选项1","选项2","选项3"],"stage":"clarifying|confirming|done","rule_update":null}

当 stage=done 时，将提取的规则填入 rule_update：
{"rule_update":{"category":"writing_style","title":"规则标题","content":"规则内容","priority":"must|should|may","examples":["示例"]}}
